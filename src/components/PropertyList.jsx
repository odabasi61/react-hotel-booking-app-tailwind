...
const PropertyList = () => {
  return (
    <div className="pList w-full max-w-[1024px] flex flex-wrap flex-col sm:flex-row justify-center gap-2 px-8 sm:px-2 lg:gap-5">
      <div className="pListItem rounded-lg overflow-hidden cursor-pointer flex-1 shadow-2xl">
        <img
        ...
        <div className="pListTitles px-2">
          ...
          <h2 className='text-lg font-normal'>233 hotels</h2>
        </div>
      </div>
      <div className="pListItem rounded-lg overflow-hidden cursor-pointer flex-1 shadow-2xl">
        <img
        ...
        <div className="pListTitles px-2">
          ...
          <h2 className='text-lg font-normal'>2331 hotels</h2>
        </div>
      </div>
      <div className="pListItem rounded-lg overflow-hidden cursor-pointer flex-1 shadow-2xl">
        <img
